...
const TestimonialSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base mt-3 text-gray-500'>Hear from our leaders as they share their journeys of transformation, success, and how our <br/> platform  has made a difference in their lives.</p>
   <div className='grid gap-8 mt-14 grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))]'>{dummyTestimonial.map((testimonial,index)=>(
